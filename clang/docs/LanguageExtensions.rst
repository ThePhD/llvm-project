...
The second overload of the builtin ``__builtin_source_location`` attempts to
"walk" up the stack that many call stack locations in order retrieve that
location. It is usable and only meaningful within constant evaluation.
